...
export default function AdminProspects() {
  ...
  return (
    <div style={{ background: "#1C1E22", color: "#ececec", fontFamily: "'Inter','Space Grotesk',ui-sans-serif,system-ui,sans-serif" }}>
                      ...
                      {replyNotes[p.id] !== undefined && (
                        <div style={{ display: "flex", alignItems: "center", gap: "0.35rem" }} onClick={e => e.stopPropagation()}>
                          <input
                            ...
                            style={{
                              fontSize: "0.8125rem",
                              background: "#1C1E22", border: "1px solid rgba(255,255,255,0.08)",
                ...
                <div style={{ marginBottom: "1rem" }}>
                  ...
                  {draftReviewEditing ? (
                    <input
                      ...
                      style={{ width: "100%", background: "#1C1E22", border: "1px solid rgba(255,255,255,0.12)", color: "#ececec", padding: "0.5rem 0.75rem", borderRadius: "0.25rem", fontSize: "0.875rem", outline: "none" }}
                    />
                  ) : (
                ...
                <div style={{ marginBottom: "1.5rem" }}>
                  ...
                  {draftReviewEditing ? (
                    <textarea
                      ...
                      rows={10}
                      style={{ width: "100%", background: "#1C1E22", border: "1px solid rgba(255,255,255,0.12)", color: "#ececec", padding: "0.5rem 0.75rem", borderRadius: "0.25rem", fontSize: "0.8125rem", outline: "none", resize: "vertical", lineHeight: 1.6 }}
                    />
                  ) : (
                    <pre style={{ fontSize: "0.8125rem", color: "rgba(255,255,255,0.75)", margin: 0, padding: "0.75rem", background: "#1C1E22", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "0.25rem", whiteSpace: "pre-wrap", lineHeight: 1.7 }}>{draftReviewBody}</pre>
                  )}
                </div>
