      ...
      <nav style={{
        ...
        <div className="container" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0.75rem 2rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "2rem" }}>
            ...
            {isAdmin && <Link href="/admin" style={{ fontSize: "0.8125rem", color: `${BRAND.emerald}`, fontWeight: 700, textDecoration: "none" }}>Admin</Link>}
            ...
            {isAuthenticated ? (
              <>
                <Link href={isAdmin ? "/admin" : "/dashboard"} style={{
                  fontSize: "0.8125rem",
                  color: isAdmin ? `${BRAND.emerald}` : "rgba(255,255,255,0.85)",
                  fontWeight: 700,
                  textDecoration: "none",
                  padding: "0.45rem 0.9rem",
                  border: isAdmin ? `1px solid ${emeraldAlpha(0.35)}` : "1px solid rgba(255,255,255,0.18)",
                  borderRadius: "6px",
        ...
        {/* Announcement strip */}
        <div style={{ borderTop: `1px solid ${emeraldAlpha(0.07)}`, background: emeraldAlpha(0.03) }}>
          <div className="container" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0.35rem 2rem" }}>
            ...
            <Link href="/shows" style={{ display: "flex", alignItems: "center", gap: "0.25rem", fontSize: "0.6875rem", color: `${BRAND.emerald}`, fontWeight: 600, letterSpacing: "0.04em", textTransform: "uppercase", textDecoration: "none" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 10, paddingBottom: "7rem", paddingTop: "5rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "flex-end" }}>
          ...
          <div>
            ...
            <h1 style={{ fontSize: "clamp(3.5rem, 8vw, 7.5rem)", fontWeight: 800, lineHeight: 0.95, letterSpacing: "-0.05em", marginBottom: "2rem" }}>
              Your Robot<br />
              <span style={{ color: `${BRAND.emerald}` }}>Performs.</span><br />
          ...
          <div style={{ paddingLeft: "2rem", borderLeft: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            <Link href="/services" style={{ display: "inline-flex", alignItems: "center", gap: "0.35rem", marginTop: "1.25rem", fontSize: "0.75rem", color: `${BRAND.emerald}`, fontWeight: 600, letterSpacing: "0.04em", textTransform: "uppercase" }}>
      ...
      <section style={{ padding: "7rem 0", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        <div className="container">
          ...
          <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 800, lineHeight: 1.05, letterSpacing: "-0.04em", marginBottom: "1rem", maxWidth: "28ch" }}>
            ...
            <span style={{ color: `${BRAND.emerald}` }}>It's a layer above freight.</span>
          </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1px", borderRadius: "12px", overflow: "hidden", marginBottom: "3rem", border: "1px solid rgba(255,255,255,0.07)" }}>
            {[
              ...
              },
              {
                ...
                color: emeraldAlpha(0.06),
                labelColor: `${BRAND.emerald}`,
                highlight: true,
              },
              {
                layer: "Layer 1",
              ...
              <div key={item.layer} style={{ padding: "2rem", background: item.color, borderLeft: item.highlight ? `2px solid ${BRAND.emerald}` : "none" }}>
                ...
                <div style={{ fontSize: "1rem", fontWeight: 700, color: item.highlight ? `${BRAND.emerald}` : "rgba(255,255,255,0.70)", marginBottom: "0.5rem", letterSpacing: "-0.02em" }}>
                  {item.name}
                </div>
            ...
            {[
              ...
              <div key={item.type} style={{ padding: "1.5rem", borderTop: "1px solid rgba(255,255,255,0.07)", borderLeft: i === 0 ? "none" : "1px solid rgba(255,255,255,0.07)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.625rem" }}>
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.5rem", letterSpacing: "0.1em", textTransform: "uppercase", color: item.status === "Live" ? `${BRAND.emerald}` : item.status === "Expanding" ? "#f59e0b" : "rgba(255,255,255,0.25)", padding: "0.125rem 0.5rem", border: `1px solid ${item.status === "Live" ? emeraldAlpha(0.30) : item.status === "Expanding" ? "rgba(245,158,11,0.30)" : "rgba(255,255,255,0.10)"}`, borderRadius: "100px" }}>
                    {item.status}
                  </span>
                </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "5fr 4fr", gap: "6rem", alignItems: "start" }}>
            ...
            <div>
              ...
              <h2 style={{ fontSize: "clamp(2.25rem, 4vw, 3.5rem)", fontWeight: 800, lineHeight: 1.05, letterSpacing: "-0.04em", marginBottom: "2rem" }}>
                The deployment OS{" "}
                <span style={{ color: `${BRAND.emerald}` }}>built for robots.</span>
              </h2>
            ...
            <div style={{ paddingTop: "3.5rem" }}>
              ...
              <div style={{ borderTop: "1px solid rgba(255,255,255,0.07)", paddingTop: "1.5rem" }}>
                <Link href="/services" style={{ display: "inline-flex", alignItems: "center", gap: "0.35rem", fontSize: "0.75rem", color: `${BRAND.emerald}`, fontWeight: 600, letterSpacing: "0.04em", textTransform: "uppercase" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0" }}>
            {(upcomingShows ?? [
              ...
              <div key={show.id} style={{ borderLeft: i === 0 ? "none" : "1px solid rgba(255,255,255,0.07)", padding: i === 0 ? "0 2rem 0 0" : "0 2rem" }}>
                <div style={{ fontFamily: "var(--font-mono)", fontSize: "0.625rem", letterSpacing: "0.10em", textTransform: "uppercase", color: `${BRAND.emerald}`, marginBottom: "1rem" }}>
                  Upcoming
                </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
            {[
              ...
              <div key={i} style={{ borderRight: i < 5 ? "1px solid rgba(255,255,255,0.07)" : "none", padding: "1.5rem 1.5rem 1.5rem 0" }}>
                <div style={{ fontFamily: "var(--font-mono)", fontSize: "0.625rem", color: emeraldAlpha(0.50), marginBottom: "0.5rem" }}>{step.num}</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "center" }}>
            ...
            <div style={{ position: "relative" }}>
              <div style={{ background: "#0a0a0a", border: "1px solid rgba(255,255,255,0.10)", borderRadius: "0.75rem", padding: "1.5rem", fontFamily: "var(--font-mono)" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.375rem", marginBottom: "1rem", paddingBottom: "0.75rem", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                  ...
                  <div style={{ width: "0.5rem", height: "0.5rem", borderRadius: "9999px", background: `${BRAND.emerald}` }} />
                ...
                {[
                  ...
                  <div key={row.ph} style={{ display: "flex", alignItems: "center", gap: "0.625rem", padding: "0.3125rem 0", borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
                    <div style={{ width: "0.875rem", height: "0.875rem", borderRadius: "9999px", flexShrink: 0, background: row.status === "done" ? emeraldAlpha(0.15) : row.status === "active" ? "rgba(245,158,11,0.15)" : "#1a1a1a", border: `1px solid ${row.status === "done" ? `${BRAND.emerald}` : row.status === "active" ? "#f59e0b" : "rgba(255,255,255,0.12)"}`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                      {row.status === "done" && <div style={{ width: "0.25rem", height: "0.25rem", borderRadius: "9999px", background: `${BRAND.emerald}` }} />}
                    ...
                    <span style={{ fontSize: "0.6875rem", color: row.status === "done" ? `${BRAND.emerald}` : row.status === "active" ? "#f59e0b" : "rgba(255,255,255,0.20)", flexShrink: 0 }}>{row.date}</span>
                  </div>
                ))}
                {/* Cost acceptance bar */}
                <div style={{ marginTop: "0.875rem", padding: "0.625rem 0.75rem", background: emeraldAlpha(0.06), border: `1px solid ${emeraldAlpha(0.15)}`, borderRadius: "0.375rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div>
                  ...
                  <div style={{ fontSize: "0.6875rem", fontWeight: 600, padding: "0.25rem 0.625rem", background: `${BRAND.emerald}`, color: "#1C1E22", borderRadius: "0.25rem" }}>Accepted ✓</div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <h2 style={{ fontSize: "clamp(2rem, 4vw, 3.25rem)", fontWeight: 800, lineHeight: 1.05, letterSpacing: "-0.04em", marginBottom: "1.5rem" }}>
                ...
                <span style={{ color: `${BRAND.emerald}` }}>Visible from anywhere.</span>
              </h2>
              ...
              {[
                ...
                <div key={i} style={{ display: "flex", gap: "1.25rem", padding: "1rem 0", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.625rem", color: emeraldAlpha(0.50), paddingTop: "0.125rem", flexShrink: 0 }}>{item.num}</span>
                  <div>
              ...
              <div style={{ marginTop: "2rem" }}>
                <Link href="/register" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", fontSize: "0.875rem", fontWeight: 600, color: "#1C1E22", background: `${BRAND.emerald}`, padding: "0.75rem 1.5rem", borderRadius: "0.375rem", textDecoration: "none" }}>
        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "start" }}>
            ...
            <div>
              ...
              <blockquote style={{ borderLeft: `2px solid ${BRAND.emerald}`, paddingLeft: "1.5rem", marginBottom: "2rem" }}>
              ...
              <a href="https://www.therobotguild.com/" target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: "0.35rem", fontSize: "0.75rem", color: `${BRAND.emerald}`, fontWeight: 600, letterSpacing: "0.04em", textTransform: "uppercase" }}>
            ...
            <div style={{ paddingTop: "4rem" }}>
              ...
              {["Curated showroom events", "Media day access", "Industry buyer introductions", "Promotional activations"].map((item, i) => (
                <div key={i} style={{ display: "flex", alignItems: "baseline", gap: "1rem", padding: "0.75rem 0", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.625rem", color: emeraldAlpha(0.40), flexShrink: 0 }}>{String(i + 1).padStart(2, "0")}</span>
      ...
      <section style={{ padding: "9rem 0", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        <div className="container">
          ...
          <h2 style={{ fontSize: "clamp(3rem, 7vw, 6rem)", fontWeight: 800, lineHeight: 0.95, letterSpacing: "-0.05em", marginBottom: "2rem", maxWidth: "16ch" }}>
            Deploy your robot{" "}
            <span style={{ color: `${BRAND.emerald}` }}>anywhere.</span>
          </h2>
