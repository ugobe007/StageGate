...
export default function AdminDemoRequests() {
  ...
  if (!user || user.role !== "admin") {
    return (
      <div
        ...
        style={{ background: "oklch(0.08 0.006 240)" }}
      >
  ...
  return (
    <div
      ...
      style={{ background: "oklch(0.08 0.006 240)", color: "oklch(0.97 0.002 240)" }}
    >
      {/* ── Header ─────────────────────────────────────────────────────────── */}
      <div
        className="border-b"
        ...
        <div className="container py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div
              ...
              style={{ background: "oklch(0.55 0.18 280 / 0.15)" }}
            >
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                background:
                  statusFilter === key
                    ? "oklch(0.72 0.21 280 / 0.10)"
                    : "transparent",
                color:
                  statusFilter === key
                    ? "oklch(0.72 0.21 280)"
                    : "oklch(0.55 0.008 240)",
              }}
            >
              {label}
              <span
        ...
        {!isLoading && filtered.length === 0 && (
          ...
          >
            ...
            <p className="font-semibold" style={{ color: "oklch(0.65 0.008 240)" }}>
              {statusFilter === "all" ? "No demo requests yet" : `No ${STATUS_CONFIG[statusFilter as DemoStatus]?.label.toLowerCase()} requests`}
            </p>
                ...
                <div
                  ...
                  style={{
                    borderColor: isExpanded
                      ? "oklch(0.72 0.21 280 / 0.40)"
                      : "oklch(0.16 0.010 240)",
                    background: "oklch(0.10 0.006 240)",
                  }}
                >
                  {/* ── Row summary ───────────────────────────────────────── */}
                  ...
                  {isExpanded && (
                    <div
                      ...
                      style={{ borderColor: "oklch(0.14 0.008 240)" }}
                    >
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex items-center gap-2">
                              ...
                              <a
                                ...
                                style={{ color: "oklch(0.72 0.21 280)" }}
                              >
                                {d.email}
                              </a>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              <span style={{ color: "oklch(0.75 0.008 240)" }}>
                                {d.company}
                              </span>
                            </div>
                          </div>
