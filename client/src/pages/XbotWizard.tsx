                ...
                <div key={step.id} className="relative flex flex-col items-center gap-1.5 z-10">
                  ...
                  <div
                    className={[
                      ...
                      isCompleted
                        ? "bg-emerald-600/80 border-emerald-500 text-white shadow-[0_0_12px_emeraldAlpha(0.4)]"
                        : isActive
                        ? "bg-[#0d0f14] border-emerald-500/60 text-emerald-300 shadow-[0_0_14px_emeraldAlpha(0.25)]"
          ...
          <div className="h-1.5 bg-white/8 rounded-full overflow-hidden">
            <div
              ...
              style={{
                ...
                boxShadow: progressPercent > 0 ? "0 0 8px emeraldAlpha(0.5)" : "none",
              }}
            />
          </div>
