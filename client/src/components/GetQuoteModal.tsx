...
const SERVICE_LINES = [
  ...
  { id: 4, name: "Live Technical Support", desc: "On-site technician during show hours", category: "support" },
  { id: 5, name: "StageHand\u2122 24/7", desc: "Round-the-clock emergency technical support", category: "support" },
