...
const SERVICE_LINES = [
  ...
  { id: 4, name: "Live Technical Support", desc: "Max coordinates on-site technicians during show hours", category: "support" },
  { id: 5, name: "StageHand\u2122 24/7", desc: "Max-led round-the-clock emergency technical support", category: "support" },
